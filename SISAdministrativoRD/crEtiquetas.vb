...
Public Class crEtiquetas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISAdministrativoRD.crEtiquetas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEtiquetas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEtiquetas = New crEtiquetas()
        rpt.Site = Me.Site
        Return rpt
    End Function
