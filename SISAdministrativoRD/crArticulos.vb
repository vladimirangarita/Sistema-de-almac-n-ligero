...
Public Class crArticulos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SISAdministrativoRD.crArticulos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrArticulos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crArticulos = New crArticulos()
        rpt.Site = Me.Site
        Return rpt
    End Function
